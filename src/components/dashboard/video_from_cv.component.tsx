    ...
    render() {
        ...
        <Card align='start' bg='#020202' color='white' p={4} borderRadius='md' boxShadow='md' w='full' maxW='full'> {/* setting the width to 100% and max-width to 100% as well, and so for the entire card */}
            ...
            <CardBody>
                ...
                <Flex alignItems='center' justify='center' h='300px'> {/* Center the image */} {/*todo: the height of the image is 300px, should be flex. coz the dashboard should be fit for the screen in 100%*/}
                    <Image
