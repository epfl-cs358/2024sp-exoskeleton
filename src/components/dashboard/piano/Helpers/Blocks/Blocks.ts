    ...
    public forcibly_add_blocks(data:{ time:number ,data:Array<noteEvent> }):void {
        ...
        data.data.map(el =>{
            ...
            const newBlock:blockNote = {
                ...
                width: this.BlackNumbers.includes(el.NoteNumber) ? this.Width / 14 / 1.8 : this.Width / 14,
    ...
    private handleAdd():void{
        ...
        this.requestToAdd.map(Event =>{
            const newBlock:blockNote = {
                ...
                width: this.BlackNumbers.includes(Event.NoteNumber) ? this.Width / 14 / 1.8 : this.Width / 14,
