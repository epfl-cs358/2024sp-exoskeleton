...
class Effects{
    ...
    constructor(ctx:CanvasRenderingContext2D,options:OptionsType,width:number,height:number){
        ...
        switch(options.Effect){
            case 'fountain':
                this.Effect = new Fountain(ctx,width,height,width/14);
            // this.Effect = new Fountain(ctx,width,height,width/52);
                break;
            case 'dancingLines':
                this.Effect = new DancingLines(ctx,height,width/14,200,1,6,12);
            // this.Effect = new DancingLines(ctx,height,width/52,200,1,6,12);
                break;
            case 'hexagon':
                this.Effect = new HexagonEffect(ctx,width,height,width/14);
            // this.Effect = new HexagonEffect(ctx,width,height,width/52);
                break;
            case 'stickyBalls':
                this.Effect = new StickyBalls(ctx,width,height,width/14);
            // this.Effect = new StickyBalls(ctx,width,height,width/52);
                break;
            case 'fireworks':
                this.Effect = new Firework(ctx,width,height,width/14);
            // this.Effect = new Firework(ctx,width,height,width/52);
                break;
            case 'sparks':
                this.Effect = new Sparks(ctx,width,height,width/14);
            // this.Effect = new Sparks(ctx,width,height,width/52);
                break;
            case 'DNA':
                this.Effect = new DNA(ctx,width,height,width/14);
