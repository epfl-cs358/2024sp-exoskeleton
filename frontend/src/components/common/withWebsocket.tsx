...
const SOCKET_URL = 'ws://localhost:7000'; // this is the URL of the WebSocket server (server-side for the WebSocket communication), not for the Next.js server (client-side for the WebSocket communication)
